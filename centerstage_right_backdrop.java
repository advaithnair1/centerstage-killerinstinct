...
@Autonomous(name = "CENTERSTAGE Right BACKDROP" +
        "" +
        "", group = "Robot")
public class centerstage_right_backdrop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            int lift_position = (int)(2786.2 * 0.10);
            liftLeftMotor.setTargetPosition(lift_position);
            liftRightMotor.setTargetPosition(lift_position);


            liftLeftMotor.setPower(0.2);
            liftRightMotor.setPower(0.2);
...
//Kaidan Lam (The best M.E. ever) was here. Class of 2023-2024

                    //  2/16/24
                    if (block.x > thirdWidth * 1 && block.x < 2 * thirdWidth && (block.id == 1 || block.id == 2)) {

                        encoderDrive(DRIVE_SPEED, 35, 35, 35, 35, 5.0);
                        sleep (200);
                        test.setPosition(0);
                        sleep (200);
                        ...
                        encoderDrive(DRIVE_SPEED + 0.2, -15, -15, -15, -15, 5.0);
                        terminateOpModeNow();

                    } else if (block.x < thirdWidth * 1 && (block.id == 1 || block.id == 2)) {
                        encoderDrive(DRIVE_SPEED, 30.5, 30.5, 30.5, 30.5, 5.0);
                        sleep (200);
                        encoderDrive(DRIVE_SPEED, -18.5, -18.5, 18.5, 18.5, 5.0);
                        sleep (200);
                        encoderDrive(DRIVE_SPEED, 5.75, 5.75, 5.75, 5.75, 5.0);
                        sleep (200);
                        test.setPosition(0);
    ...
    public void encoderDrive(double speed, double frontLeftInches, double backLeftInches, double frontRightInches, double backRightInches, double timeoutS) {
        ...
        if (opModeIsActive()) {
            ...
            while (opModeIsActive() &&
                ...
                telemetry.addData("Power for LeftFrontMotors ",
                        motorFrontLeft.getPower());
                telemetry.addData("Power for RightFronMotors ",
                        motorBackLeft.getPower());
                telemetry.addData("Power for RightBackMotors ",
                        motorBackRight.getPower());
                telemetry.addData("Power for LeftBackMotors ",
                        motorBackLeft.getPower());
                telemetry.update();
            }
